...
export class UtenteService {
     ...
     */
    getAll(onlyPmEdile: boolean = false, onlyPmAmministrativo: boolean = false, onlyPm: boolean = false, onlyAttivi: boolean = true): Observable<Utente[]> {
        ...
        if (onlyPm) {
            params = params.set('onlyPm', onlyPm.toString());
        }
