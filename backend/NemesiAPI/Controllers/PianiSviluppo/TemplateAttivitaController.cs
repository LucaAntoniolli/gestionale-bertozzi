...
namespace NemesiAPI.Controllers.PianiSviluppo
{
    ...
    public class TemplateAttivitaController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize(Policy = PermissionPolicyProvider.POLICY_PREFIX + "templateattivita.read")]
        ...
        [HttpPost]
        [Authorize(Policy = PermissionPolicyProvider.POLICY_PREFIX + "templateattivita.create")]
        ...
        [HttpPut("{id:int}")]
        [Authorize(Policy = PermissionPolicyProvider.POLICY_PREFIX + "templateattivita.update")]
        ...
        [HttpDelete("{id:int}")]
        [Authorize(Policy = PermissionPolicyProvider.POLICY_PREFIX + "templateattivita.delete")]
