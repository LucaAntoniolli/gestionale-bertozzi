...
namespace NemesiAPI.Controllers.GestioneCommesse
{
    ...
    public class ToDoController : ControllerBase
    {
        ...
        private readonly INotificheToDoService notificheToDo;

        public ToDoController(GestionaleBertozziContext db, UserManager<Utente> userManager, INotificheToDoService notificheToDo)
        {
            dbContext = db;
            this.userManager = userManager;
            this.notificheToDo = notificheToDo;
        }
        ...
        public async Task<ActionResult<ToDo>> Create([FromBody] ToDo model)
        {
            ...
            await notificheToDo.NotificaCreazioneAsync(model, UtenteCorrenteId);
        ...
        public async Task<IActionResult> Update(int id, [FromBody] ToDo model)
        {
            ...
            // Va letto prima di sovrascrivere i campi: è l'unico punto che vede lo stato
            // precedente, da cui il service di notifica ricava chi è appena stato assegnato.
            ...
            await notificheToDo.NotificaAggiornamentoAsync(existing, assegnatariPrecedenti, UtenteCorrenteId);
